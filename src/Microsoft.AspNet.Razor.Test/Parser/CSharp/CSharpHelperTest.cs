        ...
        public void ParseHelperCorrectlyParsesIncompleteHelperPreceedingCodeBlock()
        {
            ParseDocumentTest("@helper" + Environment.NewLine
                ...
                new MarkupBlock(
                    ...
                    Factory.EmptyHtml()),
                new RazorError(
                        string.Format(RazorResources.ParseError_Unexpected_Character_At_Helper_Name_Start,RazorResources.ErrorComponent_Newline),
                    7, 0, 7));
        }
        ...
        public void ParseHelperRequiresSpaceBeforeSignature()
        {
            ParseDocumentTest("@helper{",
                new MarkupBlock(
                    ...
                    Factory.Markup("{")),
                new RazorError(
                        string.Format(RazorResources.ParseError_Unexpected_Character_At_Helper_Name_Start,string.Format(RazorResources.ErrorComponent_Character, "{")),
                    7, 0, 7));
        }
        ...
        public void ParseHelperOutputsErrorButContinuesIfLParenFoundAfterHelperKeyword()
        {
            ParseDocumentTest("@helper () {",
                ...
                new RazorError(
                    ...
                    8, 0, 8),
                new RazorError(
                        string.Format(RazorResources.ParseError_Expected_EndOfBlock_Before_EOF,"helper", "}", "{"),
                    1, 0, 1));
        }
