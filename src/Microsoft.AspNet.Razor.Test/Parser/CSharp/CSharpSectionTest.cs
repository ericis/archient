    ...
    public class CSharpSectionTest : CsHtmlMarkupParserTestBase
    {
        ...
        public void ParseSectionBlockCapturesNewlineImmediatelyFollowing()
        {
            ParseDocumentTest("@section" + Environment.NewLine,
                ...
                new RazorError(
                        string.Format(RazorResources.ParseError_Unexpected_Character_At_Section_Name_Start,RazorResources.ErrorComponent_EndOfFile),
                    10, 1, 0));
        }
        ...
        public void ParseSectionBlockReportsErrorAndTerminatesSectionBlockIfKeywordNotFollowedByIdentifierStartCharacter()
        {
            ParseDocumentTest("@section 9 { <p>Foo</p> }",
                ...
                new RazorError(
                        string.Format(RazorResources.ParseError_Unexpected_Character_At_Section_Name_Start,string.Format(RazorResources.ErrorComponent_Character,"9")),
                    9, 0, 9));
        }
        ...
        public void ParserOutputsErrorOnNestedSections()
        {
            ParseDocumentTest("@section foo { @section bar { <p>Foo</p> } }",
                new MarkupBlock(
                    ...
                    Factory.EmptyHtml()),
                new RazorError(
                        string.Format(RazorResources.ParseError_Sections_Cannot_Be_Nested,RazorResources.SectionExample_CS),
                    23, 0, 23));
        }
