...
namespace Microsoft.AspNet.Razor.Test.Generator
{
        ...
        where TLanguage : RazorCodeLanguage, new()
    {
                               ...
                               Action<GeneratorResults> onResults = null)
        {
            ...
            {
                // Requires Microsoft.AspNet.Testing
                                ...
                                Action<GeneratorResults> onResults = null)
        {
            ...
            // TODO: path won't work. Need "." syntax
            ...
            string source = TestFile.Create(string.Format("Microsoft.AspNet.Razor.Test.TestFiles.CodeGenerator.CS.Source.{0}.{1}", name, FileExtension)).ReadAllText();
            string expectedOutput = TestFile.Create(string.Format("Microsoft.AspNet.Razor.Test.TestFiles.CodeGenerator.CS.Output.{0}.{1}", baselineName, BaselineExtension)).ReadAllText();
