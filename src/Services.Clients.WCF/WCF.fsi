...
module WCF =
    ...
    /// <param name="endpoint">The name of the service endpoint in configuration.</param>
    ...
    /// <remarks>
    /// <para>
    /// The service operation is executed internally as an F# asyncronous call to free the client 
