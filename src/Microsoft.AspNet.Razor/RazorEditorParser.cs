...
namespace Microsoft.AspNet.Razor
{
    ...
    public class RazorEditorParser : IDisposable
    {
        ...
        public virtual PartialParseResult CheckForStructureChanges(TextChange change)
        {
            ...
            sw.Start();
#endif
            RazorEditorTrace.TraceLine(string.Format(RazorResources.Trace_EditorReceivedChange,Path.GetFileName(FileName), change));
            if (change.NewBuffer == null)
            {
                throw new ArgumentException(string.Format(RazorResources.Structure_Member_CannotBeNull,
                                                          "Buffer",
                                                          "TextChange"), "change");
            }
            ...
            RazorEditorTrace.TraceLine(
                string.Format(RazorResources.Trace_EditorProcessedChange,
