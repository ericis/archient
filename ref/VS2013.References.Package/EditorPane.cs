...
namespace Archient.References_VS2013Package
{
    ...
    //     - An empty archref file in the same directory as NewFileItems.vsdir. In
    //       our case we chose ArchientExample.archref. Note this file name appears in Editor.vsdir
    ...
    //          - "ArchientExample" - This is the base file name. New files will initially
    //             be named as ArchientExample1.archref, ArchientExample2.archref... etc.
    ///////////////////////////////////////////////////////////////////////////////
    // Editor.vsdir contents:-
    //    ArchientExample.archref|{3085E1D6-A938-478e-BE49-3546C09A1AB1}|#106|80|#109|0|401|0|#107
    //
    // The fields in order are as follows:-
    //    - ArchientExample.archref - our empty archref file
                                ...
                                IVsToolboxUser      //Sends notification about Toolbox items to the owner of these items
    {
        ...
        private const string MyExtension = ".archref";
        ...
        /// <summary>
        /// Initialization routine for the Editor. Loads the list of properties for the archref document 
        ...
        private void setupCommands()
        {
            ...
            if (null != mcs)
            {
                ...
                addCommand(mcs, GuidList.guidReferences_VS2013PackageCmdSet, (int)PkgCmdIDList.icmdStrike,
        ...
        private void DisplayContextMenuAt(Point point)
        {
            ...
            CommandID contextMenuID = new CommandID(GuidList.guidReferences_VS2013PackageCmdSet, PkgCmdIDList.IDMX_RTF);
        ...
        {
            pClassID = GuidList.guidReferences_VS2013PackageEditorFactory;
            return VSConstants.S_OK;
        }
