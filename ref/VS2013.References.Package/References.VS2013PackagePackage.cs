...
namespace Archient.References_VS2013Package
{
    ...
    [ProvideEditorExtension(typeof(EditorFactory), ".archref", 50, 
              ProjectGuid = "{A2FE74E1-B743-11d0-AE1A-00A0C90FFFC3}", 
              TemplateDir = "Templates", 
              NameResourceID = 105,
              DefaultName = "Archient Reference VS2013 Package")]
    [ProvideKeyBindingTable(GuidList.guidReferences_VS2013PackageEditorFactoryString, 102)]
    ...
    public sealed class References_VS2013PackagePackage : Package
    {
        ...
        protected override void Initialize()
        {
            ...
            if ( null != mcs )
            {
                ...
                CommandID toolwndCommandID = new CommandID(GuidList.guidReferences_VS2013PackageCmdSet, (int)PkgCmdIDList.myExampleToolWindowID);
        ...
        private void MenuItemCallback(object sender, EventArgs e)
        {
            ...
            Microsoft.VisualStudio.ErrorHandler.ThrowOnFailure(uiShell.ShowMessageBox(
                       0,
                       ref clsid,
                       "Archient Reference VS2013 Package",
